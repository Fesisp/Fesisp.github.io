...
const projectsData = [
  // PROJETOS EM DESTAQUE
  {
    ...
    tags: ['Python', 'Flask', 'Docker', 'PostgreSQL', 'SQLAlchemy'],
  ...
  },
  {
    ...
    category: 'professional',
    featured: true,
    links: { repo: 'https://github.com/Fesisp/PokeBot', demo: '#' },
  ...
  },
  {
    ...
    tags: ['Python', 'Pytest', 'GitHub Copilot', 'GitHub Actions'],
    category: 'personal',
    featured: false,
